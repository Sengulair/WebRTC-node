...
app.get('/api/data/:code', async (req, reply) => {
...
app.listen({ port: APP_PORT, host: '0.0.0.0' }, () => console.log(`Server is listening on port ${APP_PORT}`));